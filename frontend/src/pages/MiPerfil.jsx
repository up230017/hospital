...
const MiPerfil = () => {
  ...
  const [userData, setUserData] = useState({
    ...
    phone: '+52 449-999-1010',
    address: {
      line1: "52th Cross, Ritchmond",
  ...
  return (
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      <div>
        <p className='text-neutral-500 underline mt-3'>Información de Contacto</p>
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          ...
          <p className='text-neutral-500 underline mt-3'>Informacion Básica</p>
          <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
