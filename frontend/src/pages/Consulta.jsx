    ...
    <div>
      ...
      <div className='flex flex-col sm:flex-row gap-4'>
        ...
        <div className='flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
          ...
          {/* Sobre el Médico */}
          <div>
            <p className='flex items-center gap-1 text-sm font-medium text-gray-900 mt-3'>Más Información <img src={assets.info_icon} alt="" /></p>
      ...
      <div className='sm:pl-4 sm:pr-4 mt-4 font-medium text-gray-700'>
        ...
        <button onClick={bookAppointment} className='bg-teal-500 text-white text-sm font-light px-14 py-3 rounded-full my-6'>Agendar una Consulta</button>
      </div>
